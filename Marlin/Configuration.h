 ...
 */
//#define THETA_STEPS_PER_ROT 31200.0/2.0 // = 9.75 (gear ratio) x 200 (steps per motor rev -- 1.8deg/step) x microsteps
//#define THETA_STEPS_PER_DEG THETA_STEPS_PER_ROT / 360.0
//#define THETA_STEPS_PER_RAD THETA_STEPS_PER_ROT / 6.283185
#define THETA_STEPS_PER_DEG 43.34
#define RHO_STEPS_PER_MM 80/2
#define DEFAULT_AXIS_STEPS_PER_UNIT   { THETA_STEPS_PER_DEG, RHO_STEPS_PER_MM, 400, 500 }
...
#define X_BED_SIZE 3600000 // +/-5,000 "loops"
#define Y_BED_SIZE 340*2   // 340 = radial distance from center to outer edge, can move +/- this amount
